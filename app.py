...
def index():
    return render_template("index.html")  # Redirect to the quiz page
...
def result():
    return render_template(
        ...
        total_questions=10,
        correct_answers=7,  # Optional, if scores are tracked
        recommendation_1="Review data types and variables",
        recommendation_2="Practice loops and conditions",
        recommendation_3="Understand basic Python syntax"
    )
